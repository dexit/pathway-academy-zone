...
const terms: { term: string; slug: string; definition: string }[] = [
  { term: "Alternative Provision (AP)", slug: "alternative-provision", definition: "Education arranged for pupils who, because of exclusion, illness, or other reasons, would not otherwise receive suitable education. Alternative Provision can be delivered by local authorities, schools, or registered providers outside of mainstream and special school settings." },
  { term: "Social, Emotional and Mental Health (SEMH)", slug: "semh", definition: "A category of Special Educational Needs (SEND) covering difficulties with social interaction, emotional regulation, and mental health that significantly impact a young person's ability to learn. SEMH needs often require specialist support and therapeutic interventions within an Alternative Provision setting." },
  ...
  { term: "Progression Routes", slug: "progression-routes", definition: "The pathways available to young people when they complete their Alternative Provision placement. These include return to mainstream school, college, apprenticeships, employment, or continued specialist provision depending on individual needs and aspirations." },
  { term: "Permanent Exclusion", slug: "permanent-exclusion", definition: "When a headteacher decides that a pupil should no longer attend their school. This is the most serious sanction available and should only be used as a last resort. Local authorities must arrange Alternative Provision from day 6 of a permanent exclusion." },
  { term: "Fixed-Term Exclusion (Suspension)", slug: "fixed-term-exclusion", definition: "When a pupil is temporarily removed from school for a set period. Schools must provide work for the first 5 days and arrange Alternative Provision from day 6. A pupil can receive a maximum of 45 days of fixed-term exclusion in one school year." },
  { term: "Pupil Referral Unit (PRU)", slug: "pru", definition: "A type of school established and maintained by local authorities specifically to provide education for children who are excluded, sick, or otherwise unable to attend mainstream school. Pupil Referral Units are a form of Alternative Provision." },
  { term: "Designated Safeguarding Lead (DSL)", slug: "dsl", definition: "The person in a school or Alternative Provision setting with overall responsibility for safeguarding and child protection. The DSL is the first point of contact for concerns, coordinates with external agencies, and ensures staff are trained." },
  ...
  { term: "NEET (Not in Education, Employment or Training)", slug: "neet", definition: "A classification for young people aged 16-24 who are not engaged in any form of education, employment, or training. Reducing NEET rates is a key outcome measure for specialist Alternative Provision providers." },
];
...
export default function Glossary() {
  ...
  return (
    <Layout>
      <Seo
        title="Alternative Provision Glossary | Pathway Academy Zone"
        description="Searchable A–Z glossary of Alternative Provision, Social, Emotional and Mental Health (SEMH) and educational terminology for educators, parents and professionals across Staffordshire."
        jsonLd={jsonLd}
      />
      ...
      <header className="bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            />
            <div className="inline-flex items-center gap-2 rounded-full bg-accent/20 text-accent px-4 py-1.5 text-xs font-bold tracking-widest uppercase mb-6 backdrop-blur-sm border border-accent/20">
            ...
            <p className="text-primary-foreground/90 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
              ...
              supporting educators, parents, and professionals across the region.
            </p>
          </div>
        </div>
      </header>
