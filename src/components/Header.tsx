...
const navLinks: NavItem[] = [
  { label: "Home", path: "/" },
  {
    ...
    children: [
      ...
      { label: "Our Team",       path: "/team",     description: "Meet the people behind Pathway Academy Zone",          icon: Users },
  ...
  },
  {
    ...
    children: [
      { label: "Our Programmes",   path: "/programmes", description: "Full overview of all Alternative Provision programmes",       icon: GraduationCap, highlight: true },
  ...
  },
  {
    ...
    megaSize: "xl",
    promo: {
      heading: "Complete Guide to Alternative Provision",
    ...
    children: [
      { label: "Knowledge Hub",    path: "/knowledge-hub",              description: "Browse all Alternative Provision resources",          icon: BookOpen, highlight: true },
      { label: "Complete Guide",   path: "/knowledge-hub/complete-guide", description: "The full Alternative Provision journey in one place", icon: FileText },
      { label: "Best Practice",    path: "/knowledge-hub/best-practice",  description: "Evidence-based Alternative Provision guidance",       icon: Star },
      { label: "Glossary",         path: "/knowledge-hub/glossary",        description: "A–Z of Alternative Provision & Social, Emotional and Mental Health (SEMH) terminology",    icon: BookMarked },
...
const dropdownVariants = {
  ...
  show:   { opacity: 1, y: 0, scale: 1,   transition: { duration: 0.18, ease: [0.16, 1, 0.3, 1] as [number, number, number, number] } },
